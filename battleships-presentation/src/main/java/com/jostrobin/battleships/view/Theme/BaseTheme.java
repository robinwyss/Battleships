...
public abstract class BaseTheme implements Theme
{
    ...
    protected Image[] aircraftCarrier = new Image[5];
    protected Image[] battleship = new Image[4];
    protected Image[] destroyer = new Image[3];
    protected Image[] submarine = new Image[3];
    protected Image[] patrolBoat = new Image[2];
